...
const Skills = () => {
  return (
    <div className="container skillContainer">
      <h1 className="text-center mb-4 titleSize text-decoration-underline">
        Skills
      </h1>
          ...
          <div className="card shadow border-0 h-100 d-flex flex-column skillCard">
            <div className="card-body">
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">
                  <i className="bi bi-terminal me-2"></i> DevOps
                </li>
                <li className="list-group-item">
                  <i className="bi bi-arrow-repeat me-2"></i> CI/CD
                </li>
                <li className="list-group-item">
                  <i className="bi bi-gear me-2"></i> Jenkins
                </li>
                <li className="list-group-item">
                  <i className="bi bi-robot me-2"></i> Robot Framework
                </li>
                <li className="list-group-item">
        ...
        <div className="col-md-4 mb-4">
          <div className="card shadow border-0 h-100 d-flex flex-column skillCard">
            <div className="card-body">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">
                  <i className="bi bi-clipboard-data me-2"></i> Agile
                  Methodology
                </li>
                <li className="list-group-item">
